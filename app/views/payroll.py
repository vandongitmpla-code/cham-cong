...
def payroll(filename):
    ...
    try:
        ...
        # ---- Lấy kỳ công (vd: 2025-08-01 ~ 2025-08-31) ----
        period_str = ""
        ...
        # ---- Chuẩn bị dữ liệu xuất bảng ----
        cols = ["Mã", "Tên", "Phòng ban", "Ngày công", "Ngày vắng", "Chủ nhật"] \
               + [str(i) for i in range(1, day_count + 1)]
        records = []
