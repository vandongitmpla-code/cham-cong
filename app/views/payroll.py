    ...
    try:
        ...
        def calculate_adjusted_work_days(ngay_cong_thuc_te, ngay_cong_chuan, tang_ca_nghi_gio, ngay_vang_ban_dau, ngay_nghi_phep_nam_da_dung=0):
            ...
            used_hours = so_ngay_bu_tu_tang_ca_final * 8
                ...
                return adjusted_days, ngay_vang_cuoi, remaining_hours, used_hours, so_ngay_bu_tu_tang_ca_final, ngay_nghi_phep_nam_da_dung_find
...
def apply_adjustment(): 
    try:
        ...
        ngay_nghi_phep_nam_da_dung = paid_leave.leave_days_used if paid_leave else 0
